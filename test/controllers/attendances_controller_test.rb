...
class AttendancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attendance" do
    assert_difference('Attendance.count') do
      post attendances_url, params: { attendance: { eventID: @attendance.eventID, index: @attendance.index, memID: @attendance.memID } }
    end
  ...
  test "should update attendance" do
    patch attendance_url(@attendance), params: { attendance: { eventID: @attendance.eventID, index: @attendance.index, memID: @attendance.memID } }
